...
| 2026-04-13 | Thêm 4 cột vào Sheet1: Tổng bán toàn TG, Doanh thu toàn TG, Doanh thu 3T (từ cột revenue trong file bán hàng, fallback 0 nếu không có); thứ tự: Tổng bán TG → Doanh thu TG → Đã bán 3T → Doanh thu 3T | Cần xem doanh thu theo SKU × cửa hàng |
| 2026-04-13 | Bỏ subtotal Sheet "Fill từ kho" (show_subtotal=False); thay sku_cat→prod_attrs: bổ sung đủ 6 cột BRAND/Category/Model/Sub Category/Color/Frame Size vào cả 2 sheet (tự map từ các tên cột phổ biến, bỏ trống nếu không có); fix mousewheel scroll CheckListbox bằng cách bind _scroll_cmd lên từng Checkbutton; tăng CheckListbox height 130→200, window 720→820 | UX và completeness dữ liệu sản phẩm |
